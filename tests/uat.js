...
test('APP_VERSION is 4.59.4', js.includes("const APP_VERSION = '4.59.4"));
...
test('SW cache bumped to v4.59.4', sw.includes('netplus-v4.59.4'));
...
(function testExemplarBank() {
  try {
    ...
    test('v4.59.4 bank: 156 exemplars present (134 + 22 Road-to-200 Batch 4)',
      Array.isArray(bank) && bank.length === 156);
    ...
    test('v4.59.4 bank: Domain 1.0 contains 35 exemplars (+5 Batch 4)',
      d1Count === 35);
    test('v4.59.4 bank: Domain 2.0 contains 31 exemplars (+5 Batch 4)',
      d2Count === 31);
    test('v4.59.4 bank: Domain 3.0 contains 29 exemplars (+4 Batch 4)',
      d3Count === 29);
    test('v4.59.4 bank: Domain 4.0 contains 28 exemplars (+3 Batch 4)',
      d4Count === 28);
    test('v4.59.4 bank: Domain 5.0 contains 33 exemplars (+5 Batch 4)',
      d5Count === 33);
    test('v4.59.4 bank: domain distribution sums to 156 (35+31+29+28+33)',
      d1Count + d2Count + d3Count + d4Count + d5Count === 156);
