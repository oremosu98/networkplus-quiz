...
> **Older releases** (v3.0 through v4.65.0 — 135 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference. Reorg established during the v4.42.3 maintenance pass; most recent trim was during v4.74.0 (Spaced Repetition Queue — second of 3 Sunday pass-rate-driver ships).
...
> **Older releases** (v3.0 through v4.65.0, 135 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference.
