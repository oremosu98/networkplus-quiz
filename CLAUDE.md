...
> **Older releases** (v3.0 through v4.66.0 — 137 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference. Reorg established during the v4.42.3 maintenance pass; most recent trim was during v4.75.1 (HeroV2 prediction visibility fix — closes the Sunday session).
...
> **Older releases** (v3.0 through v4.66.0, 137 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference.
