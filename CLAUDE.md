...
> **Older releases** (v3.0 through v4.62.5 — 132 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference. Reorg established during the v4.42.3 maintenance pass; most recent trim was during v4.72.0 (final 5-scenario tour batch — catalog now 100% complete at 19/19).
...
> **Older releases** (v3.0 through v4.62.5, 132 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference.
