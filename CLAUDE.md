...
> **Older releases** (v3.0 through v4.62.3 — 131 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference. Reorg established during the v4.42.3 maintenance pass; most recent trim was during v4.71.0 (4th batch of 3 scenario tours — Site-to-Site VPN + MPLS + SASE).
...
> **Older releases** (v3.0 through v4.62.3, 131 rows) live in [CHANGELOG.md](./CHANGELOG.md). The last 11 releases stay inline here for quick reference.
