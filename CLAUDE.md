...
| `app.js` | All app logic — state, AI calls, rendering, game loops, analytics, 5 activity sub-systems | **~1.24 MB / 20,874 lines** |
...
| `tests/uat.js` | UAT suite — **2,764 assertions** as of v4.48.0, embeds validation-audit gate | 4,553 lines |
